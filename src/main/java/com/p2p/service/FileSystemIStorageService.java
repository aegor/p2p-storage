...
import com.p2p.exceptions.StorageException;
import com.p2p.exceptions.StorageFileNotFoundException;
...
public class FileSystemIStorageService implements IStorageService {
    ...
    @Autowired
    public FileSystemIStorageService(StorageConfig properties) {
