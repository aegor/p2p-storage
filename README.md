...
- deletestorage - удалить весь storage (автоматически останавливает весь конвеер)
- break - Остановить конвеер
...
- Поддержка семантики фолдеров
- Readonly public http endpoint для контента с фолдерами (Amazon style) 
